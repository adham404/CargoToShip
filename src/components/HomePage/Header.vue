<template>
    ...
    <v-toolbar-title class="d-flex align-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="22%" height="100%" viewBox="0 0 68.857 70.786">
