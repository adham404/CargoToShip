...
import FindShip from "../views/FindShip";
import FindCargo from "../views/FindCargo";
import FilterShip from '../components/FilterShip'; //Import the Filter ship form Component
import FilterCargo from '../components/FilterCargo'; //Import the Filter ship form Component
...
export default {
  data: function(){
    return{
      ...
      CurrentComponent:"FindShip",  //Current Component that  hold either the cargo card or the ship card
  ...
  methods:{
    ...
    GoToCargo: function()
    {
      this.CurrentComponent = FindCargo;
